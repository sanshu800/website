 ...
 * a browser that drops the session cookie would navigate to `/dashboard`, be
 * redirected back to `/login`, and the person would be told nothing — which
 * looks exactly like "sign in is broken".
 */
