      ...
      <div className="mt-6 space-y-4">
        <label className="block">
          ...
          <input
            ...
            autoComplete="name"
            required
            className="mt-2 w-full rounded-lg border border-field bg-paper px-3.5 py-2.5 text-[0.9375rem] outline-none transition-colors focus:border-accent"
          />
        </label>
        <label className="block">
          <span className="font-mono text-[0.625rem] uppercase tracking-wide text-fog">
        ...
        <label className="block">
          ...
          <textarea
            ...
            className="mt-2 w-full resize-y rounded-lg border border-field bg-paper px-3.5 py-2.5 text-[0.9375rem] outline-none transition-colors focus:border-accent"
          />
        </label>
      </div>
